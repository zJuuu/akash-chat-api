...
export default function Index() {
  ...
  async function handleSubmit(e: FormEvent): Promise<boolean | undefined> {
    ...
    if (step === 1) {
      ...
      if (tempApiKey) {
        console.log('Using temporary API key from Auth0 flow');
      ...
      console.log('Form data:', { name, email, description, authType, tos, emailConsent });
      ...
      console.log('Sending request to /api/users/claim-api-key');
      ...
      if (res.ok) {
        ...
        if (data.sessionId) {
          ...
          console.log('Session created, triggering auth refresh...');
